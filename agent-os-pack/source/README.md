...
Open **http://localhost:3001** in your browser. This workspace is pinned to `3001` so the app stays on one stable local address.
...
- `http://localhost:3001` — Mission Control overview
- `http://localhost:3001/claude` — Claude chat (needs Claude Code installed)
- `http://localhost:3001/openclaw` — OpenClaw chat + control room
- `http://localhost:3001/hermes` — Hermes chat + control room
- `http://localhost:3001/memory` — Search your Obsidian vault
- `http://localhost:3001/goals` — Goals (writes to vault)
- `http://localhost:3001/journal` — Daily journal
- `http://localhost:3001/guide` — How-to-build-your-own guide
...
- `http://localhost:3001/guide` once it's running
