...
//   Apps · Main Workspace · Julian Workspace · Marketing Workspace ·
    ...
    <div className="space-y-4">
      ...
      <div className="relative overflow-hidden rounded-xl border p-4"
        ...
        <div className="flex items-center gap-3 mb-1">
          ...
          <div>
            <div className="text-[10px] uppercase tracking-widest" style={{ color: ACCENT }}>Kairos · Workspace</div>
            <div className="text-[15px] font-medium text-[var(--cream)]">
              Everything Kairos has ever built
            </div>
          </div>
            ...
            <div className="flex-1 min-h-0 overflow-y-auto scroll p-2 space-y-0.5">
              {loading ? (
                ...
                <div className="text-[11px] text-[var(--cream-mute)] italic p-3">
                  This bucket is empty. Run something through Kairos — chat, a flow, a skill — and the outputs will land here.
                </div>
              ) : files.map((f) => {
